...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/5v5 ATOI Projections/Age Unadjusted/5v5 ATOI Projector - Forward Board.csv')
...
regr.fit(X, y)
print()
print('--FORWARD 3-YEAR REGRESSION--')
