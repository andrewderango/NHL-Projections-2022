...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/5v5 ATOI Projections/Age Adjusted/Total/5v5 ATOI Projector - Age-Adjusted Big Board.csv')
