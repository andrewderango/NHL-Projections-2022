...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PK Shots60 Projections/Age Unadjusted/PK Shots60 Projector - Forward Board.csv')
