...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV ATOI Projections/Age Adjusted/Forwards/EV ATOI Projector - Age-Adjusted Forward Board.csv')
