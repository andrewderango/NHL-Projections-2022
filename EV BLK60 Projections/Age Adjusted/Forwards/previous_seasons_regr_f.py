...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV BLK60 Projections/Age Adjusted/Forwards/EV BLK60 Projector - Age-Adjusted Forward Board.csv')
