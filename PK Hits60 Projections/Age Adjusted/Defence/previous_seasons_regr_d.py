...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PK Hits60 Projections/Age Adjusted/Defence/PK Hits60 Projector - Age-Adjusted Defence Board.csv')
