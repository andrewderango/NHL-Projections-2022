...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP iCF60 Projections/Age Adjusted/Forwards/PP iCF60 Projector - Age-Adjusted Forward Board.csv')
