...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/FL60 Projections/Age Adjusted/Total/FL60 Projector - Age-Adjusted Big Board.csv')
