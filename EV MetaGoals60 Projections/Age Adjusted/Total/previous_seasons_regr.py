...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaGoals60 Projections/Age Adjusted/Total/EV MetaGoals60 Projector - Age-Adjusted Big Board.csv')
