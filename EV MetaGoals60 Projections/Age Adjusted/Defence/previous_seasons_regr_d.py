...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaGoals60 Projections/Age Adjusted/Defence/EV MetaGoals60 Projector - Age-Adjusted Defence Board.csv')
