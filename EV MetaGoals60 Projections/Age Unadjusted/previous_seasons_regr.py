...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaGoals60 Projections/Age Unadjusted/EV MetaGoals60 Projector - Big Board.csv')
