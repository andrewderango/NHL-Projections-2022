...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV SH% Projections/Age Adjusted/Defence/EV SH% Projector - Age-Adjusted Defence Board.csv')
