...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV SH% Projections/Age Adjusted/Forwards/EV SH% Projector - Age-Adjusted Forward Board.csv')
