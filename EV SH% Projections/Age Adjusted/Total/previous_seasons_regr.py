...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV SH% Projections/Age Adjusted/Total/EV SH% Projector - Age-Adjusted Big Board.csv')
