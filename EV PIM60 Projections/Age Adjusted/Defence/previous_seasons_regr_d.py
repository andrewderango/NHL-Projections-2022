...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV PIM60 Projections/Age Adjusted/Defence/EV PIM60 Projector - Age-Adjusted Defence Board.csv')
