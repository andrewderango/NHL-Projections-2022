...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV PIM60 Projections/Age Adjusted/Total/EV PIM60 Projector - Age-Adjusted Big Board.csv')
