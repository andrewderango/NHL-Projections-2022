...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP MetaGoals60 Projections/Age Adjusted/Total/PP MetaGoals60 Projector - Age-Adjusted Big Board.csv')
