...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP MetaGoals60 Projections/Age Unadjusted/PP MetaGoals60 Projector - Defence Board.csv')
