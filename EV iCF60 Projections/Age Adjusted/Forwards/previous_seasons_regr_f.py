...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV iCF60 Projections/Age Adjusted/Forwards/EV iCF60 Projector - Age-Adjusted Forward Board.csv')
