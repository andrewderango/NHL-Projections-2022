...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaPAssists60 Projections/Age Adjusted/Total/EV MetaPAssists60 Projector - Age-Adjusted Big Board.csv')
