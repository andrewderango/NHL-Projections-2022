...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaPAssists60 Projections/Age Adjusted/Forwards/EV MetaPAssists60 Projector - Age-Adjusted Forward Board.csv')
