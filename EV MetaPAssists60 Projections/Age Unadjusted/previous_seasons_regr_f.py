...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaPAssists60 Projections/Age Unadjusted/EV MetaPAssists60 Projector - Forward Board.csv')
