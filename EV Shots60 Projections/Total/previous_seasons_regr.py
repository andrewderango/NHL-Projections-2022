...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV Shots60 Projections/Total/2021-22 EV Shots60 Projector - Filtered Board.csv')
