...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV Shots60 Projections/Forwards/2021-22 EV Shots60 Projector - Forward Board.csv')
