...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP MetaSAssists60 Projections/Age Unadjusted/PP MetaSAssists60 Projector - Forward Board.csv')
