...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP BLK60 Projections/Age Adjusted/Forwards/PP BLK60 Projector - Age-Adjusted Forward Board.csv')
