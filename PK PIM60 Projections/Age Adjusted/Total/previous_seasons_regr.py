...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PK PIM60 Projections/Age Adjusted/Total/PK PIM60 Projector - Age-Adjusted Big Board.csv')
