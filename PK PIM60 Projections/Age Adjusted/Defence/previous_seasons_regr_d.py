...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PK PIM60 Projections/Age Adjusted/Defence/PK PIM60 Projector - Age-Adjusted Defence Board.csv')
