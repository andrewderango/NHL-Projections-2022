...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaShots60 Projections/Age Adjusted/Total/EV MetaShots60 Projector - Age-Adjusted Big Board.csv')
