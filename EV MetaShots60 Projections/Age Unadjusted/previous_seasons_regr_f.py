...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaShots60 Projections/Age Unadjusted/EV MetaShots60 Projector - Forward Board.csv')
