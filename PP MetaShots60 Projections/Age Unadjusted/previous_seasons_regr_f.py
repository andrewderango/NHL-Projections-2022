...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP MetaShots60 Projections/Age Unadjusted/PP MetaShots60 Projector - Forward Board.csv')
