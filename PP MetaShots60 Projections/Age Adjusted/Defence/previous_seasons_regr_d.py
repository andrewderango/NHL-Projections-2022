...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP MetaShots60 Projections/Age Adjusted/Defence/PP MetaShots60 Projector - Age-Adjusted Defence Board.csv')
