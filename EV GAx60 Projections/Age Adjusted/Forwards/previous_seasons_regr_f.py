...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV GAx60 Projections/Age Adjusted/Forwards/EV GAx60 Projector - Age-Adjusted Forward Board.csv')
