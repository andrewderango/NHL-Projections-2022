...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaSAssists60 Projections/Age Adjusted/Total/EV MetaSAssists60 Projector - Age-Adjusted Big Board.csv')
...
regr.fit(X, y)
print()
print('--ALL POSITIONS 3-YEAR REGRESSION--')
