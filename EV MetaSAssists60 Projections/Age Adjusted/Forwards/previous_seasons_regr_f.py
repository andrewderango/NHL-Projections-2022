...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV MetaSAssists60 Projections/Age Adjusted/Forwards/EV MetaSAssists60 Projector - Age-Adjusted Forward Board.csv')
