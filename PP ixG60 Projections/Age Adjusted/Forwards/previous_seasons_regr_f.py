...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP ixG60 Projections/Age Adjusted/Forwards/PP ixG60 Projector - Age-Adjusted Forward Board.csv')
