...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV Hits60 Projections/Age Adjusted/Forwards/EV Hits60 Projector - Age-Adjusted Forward Board.csv')
