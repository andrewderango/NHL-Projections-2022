...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP Hits60 Projections/Age Adjusted/Defence/PP Hits60 Projector - Age-Adjusted Defence Board.csv')
