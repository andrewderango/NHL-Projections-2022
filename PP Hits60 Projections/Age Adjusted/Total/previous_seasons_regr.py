...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP Hits60 Projections/Age Adjusted/Total/PP Hits60 Projector - Age-Adjusted Big Board.csv')
