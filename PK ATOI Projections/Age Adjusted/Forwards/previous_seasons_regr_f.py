...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PK ATOI Projections/Age Adjusted/Forwards/PK ATOI Projector - Age-Adjusted Forward Board.csv')
