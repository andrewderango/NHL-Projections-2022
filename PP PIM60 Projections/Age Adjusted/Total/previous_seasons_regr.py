...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP PIM60 Projections/Age Adjusted/Total/PP PIM60 Projector - Age-Adjusted Big Board.csv')
