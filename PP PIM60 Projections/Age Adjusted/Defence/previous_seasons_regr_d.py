...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP PIM60 Projections/Age Adjusted/Defence/PP PIM60 Projector - Age-Adjusted Defence Board.csv')
