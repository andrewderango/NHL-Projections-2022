...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP PIM60 Projections/Age Adjusted/Forwards/PP PIM60 Projector - Age-Adjusted Forward Board.csv')
