...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP ATOI Projections/Age Adjusted/Total/PP ATOI Projector - Age-Adjusted Big Board.csv')
