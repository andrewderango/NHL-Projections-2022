...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/PP ATOI Projections/Age Adjusted/Forwards/PP ATOI Projector - Age-Adjusted Forward Board.csv')
