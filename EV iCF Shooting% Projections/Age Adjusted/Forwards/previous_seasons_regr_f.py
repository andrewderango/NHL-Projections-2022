...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV iCF Shooting% Projections/Age Adjusted/Forwards/EV iCF Shooting% Projector - Age-Adjusted Forward Board.csv')
