...
big_board = pd.read_csv('/users/andrewderango/Documents/Python/NHL Projections/EV iCF Shooting% Projections/Age Adjusted/Defence/EV iCF Shooting% Projector - Age-Adjusted Defence Board.csv')
